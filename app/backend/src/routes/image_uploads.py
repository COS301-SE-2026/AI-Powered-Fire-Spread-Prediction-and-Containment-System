...
@router.post("/photo", responses={400: {"description": "Invalid file type or file size to big"}})
async def upload_image_endpoint(file: UploadFile, current_user: Annotated[Optional[User], Depends(get_current_user_optional)],):
