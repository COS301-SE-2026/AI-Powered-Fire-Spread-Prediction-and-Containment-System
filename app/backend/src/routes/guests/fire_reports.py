...
from src.schemas.fire_report import FireReportCreate, FireReportDetailResponse, FireReportMapResponse
from src.services.users import fire_report
...
def create_fire_report(report:FireReportCreate, request:Request, db:Session = Depends(get_db), user_id:Optional[str] = None): # I think we need to still add a different service for guests just not sure what yet
