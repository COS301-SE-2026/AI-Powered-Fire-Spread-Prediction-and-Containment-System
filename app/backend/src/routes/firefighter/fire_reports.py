...
# Search for table
@router.get("/reported-fires/search", response_model=ReportList, responses={404: {"description": "key is not found"}})
...
@router.get("/reported-fires/{ref}", response_model=FirefighterReportModal, responses={404: {"description": "Fire report not found"}})
