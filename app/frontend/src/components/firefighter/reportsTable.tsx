                        ...
                        filtered.map((req) => {
                            return(
                                <tr key={req.ref} className="hover:bg-[var(--color-surface-hover)] even:bg-carbon-bg/80">
                                    ...
                                    <td className="py-4 text-sm text-text-primary border-t border-carbon-card">{new Date(req.reported).toLocaleDateString("en-ZA", {day: "2-digit", month: "2-digit", year: "numeric"})}</td>
