...
export function ActionCard({title, description, icon}: ActionCardProps){
    return(
        <button
            className="flex items-center gap-4 p-5 rounded-xl bg-carbon-side/60 backdrop-blur-sm border border-carbon-card hover:border-ignite hover:bg-smoke-hover active:scale-[0.98] transition-all text-left w-full group"
        >
            {/* Icon wrapper */}
