            ...
            <aside className="hidden lg:flex flex-col items-center bg-carbon-side border-r border-carbon-card h-screen sticky top-0 z-40 transition-all duration-300 ease-in-out group w-[92px] hover:w-64 shrink-0 shadow-2xl shadow-black/50">
                ...
                <div className="w-full grow overflow-y-auto overflow-x-hidden">
                    <ul className="menu w-full px-3 space-y-3 flex flex-col items-center group-hover:items-start">
                        <li className="w-full">
                            <button type="button" className="py-3 px-4 rounded-xl flex items-center justify-center group-hover:justify-start gap-5 hover:bg-smoke-hover active:scale-[0.98] transition-all w-full text-left">
                                <LayoutDashboard className="size-6 text-text-primary/70 group-hover:text-ignite shrink-0 transition-colors" />
                                <span className="text-sm font-semibold tracking-wide text-text-primary hidden group-hover:inline opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap">Firefighter Dashboard</span>
                            </button>
                        </li>
                        <li className="w-full">
                            <button className="py-3 px-4 rounded-xl flex items-center justify-center group-hover:justify-start gap-5 hover:bg-smoke-hover active:scale-[0.98] transition-all w-full text-left">
                                ...
                                <span className="text-sm font-semibold tracking-wide text-text-primary hidden group-hover:inline opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap">Reported Fires</span>
                            </button>
                        </li>
                        <li className="w-full">
                            <button className="py-3 px-4 rounded-xl flex items-center justify-center group-hover:justify-start gap-5 hover:bg-smoke-hover active:scale-[0.98] transition-all w-full text-left">
                                <Map className="size-6 text-text-primary/70 group-hover:text-ignite shrink-0 transition-colors" />
                                <span className="text-sm font-semibold tracking-wide text-text-primary hidden group-hover:inline opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap">Fire Simulation</span>
                            </button>
                        </li>

                        <div className="w-full text-center mt-4 mb-1 px-2 border-t border-carbon-card pt-4 shrink-0">
                            <span className="text-[10px] font-bold tracking-widest text-text-primary/40 uppercase block group-hover:hidden">SETTINGS</span>
                            <span className="text-[10px] font-bold tracking-widest text-text-primary/40 uppercase hidden group-hover:block text-left px-4">SYSTEM SETTINGS</span>
                        </div>
                        ...
                        <li className="w-full mt-auto">
                            <button className="py-3 px-4 rounded-xl flex items-center justify-center group-hover:justify-start gap-5 hover:bg-smoke-hover active:scale-[0.98] transition-all w-full text-left">
                                ...
                                <span className="text-sm font-semibold tracking-wide text-text-primary hidden group-hover:inline opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap">Settings</span>
                            </button>
                        </li>
                    </ul>
                </div>
