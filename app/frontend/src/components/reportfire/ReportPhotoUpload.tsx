    ...
    return (
        <div className="w-full">
            ...
            <input ref={fileRef} type="file" accept="image/*" onChange={handlePhotoChange} className = "hidden" />
                <button type="button" onClick={() => fileRef.current?.click()} className="h-11 w-full flex items-center justify-center gap-2 rounded-md border text-sm transition-colors duration-150">
                    {value ? (
                        <>
