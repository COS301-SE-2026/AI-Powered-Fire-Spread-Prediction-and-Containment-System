        ...
        <table className="table table-pin-rows w-full">
          <thead>
            <tr className="[&>th]:bg-carbon-bg [&>th]:border-b [&>th]:border-primary/40">
              <th className="text-left text-xs font-bold font-display tracking-widest text-text-primary uppercase px-4 py-3 whitespace-nowrap">
                Ref
              </th>
              <th className="text-left text-xs font-bold font-display tracking-widest text-text-primary uppercase px-4 py-3 whitespace-nowrap">
                Location
          ...
          <tbody>
            <tr className="[&>td]:border-t [&>td]:border-carbon-stroke hover:bg-carbon-card/50 even:bg-carbon-bg/80">
              ...
              <td className="px-4 py-3 whitespace-nowrap">
                <button
                  type="button"
                  className="text-xs font-semibold px-3 py-1.5 rounded-lg border border-carbon-stroke text-text-primary/50 hover:bg-carbon-card hover:text-text-primary transition-colors"
                >
                  View
                </button>
              </td>
