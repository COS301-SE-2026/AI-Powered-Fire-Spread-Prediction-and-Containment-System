import { LayoutDashboard, Flame, Map, BookAlert, ShieldAlert, Settings, Wind, Thermometer, Droplets, UserCircle, User, LogOut, PlusCircle, AlertTriangle, TrendingUp, ChevronDown, ChevronRight, MicrochipIcon, HeartIcon, LineChartIcon, DownloadCloudIcon, Users, FileWarning, PenLine, Paperclip, Check, House, MessageCircleWarning, MessagesSquare, Info } from 'lucide-react';
