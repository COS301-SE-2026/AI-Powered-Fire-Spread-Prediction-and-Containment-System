...
export function LogoCard({ src, filename, note, imgHeight }: Readonly<LogoCardProps>) {
    return (
        <div className="overflow-hidden rounded-md border border-carbon-stroke">
            <div className="flex h-40 items-center justify-center bg-carbon-side overflow-hidden">
