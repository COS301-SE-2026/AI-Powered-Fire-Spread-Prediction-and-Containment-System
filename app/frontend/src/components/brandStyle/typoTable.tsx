...
const pageTitle: TypoScale = {
  label: 'Page title',
  token: '--text-page-title',
  size: '3.25rem',
  sizeValue: 'text-page-title',
  font: 'font-display',
  weightName: 'font-extrabold',
  family: 'Barlow Condensed',
  weight: '800',
  lineHeight: '1.05',
  letterSpace: '0.04em',
  sample: 'Report a fire',
};
const sectionHead: TypoScale = {
  label: 'Section head',
  token: '--text-section-head',
  size: '2rem',
  sizeValue: 'text-section-head',
  font: 'font-display',
  weightName: 'font-bold',
  family: 'Barlow Condensed',
  weight: '700',
  lineHeight: '1.1',
  letterSpace: '0.04em',
...
const cardTitle: TypoScale = {
  label: 'Card title',
  token: '--text-card-title',
  size: '1.35rem',
  sizeValue: 'text-card-title',
  font: 'font-body',
  weightName: 'font-semibold',
  family: 'Exo 2',
  weight: '600',
  lineHeight: '1.3',
  letterSpace: 'normal',
...
const body: TypoScale = {
  label: 'Body',
  token: '--text-body',
  size: '1rem',
  sizeValue: 'text-body',
  font: 'font-body',
  weightName: 'font-normal',
  family: 'Exo 2',
  weight: '400',
  lineHeight: '1.7',
  letterSpace: 'normal',
  sample: 'Click the map to drop a pin',
};
const label: TypoScale = {
  label: 'Label',
  token: '--text-label',
  size: '0.8rem',
  sizeValue: 'text-label',
  font: 'font-body',
  weightName: 'font-medium',
  family: 'Exo 2',
  weight: '500',
  lineHeight: '1.4',
  letterSpace: '0.06em',
...
const caption: TypoScale = {
  label: 'Caption',
  token: '--text-caption',
  size: '0.75rem',
  sizeValue: 'text-caption',
  font: 'font-mono',
  weightName: 'font-normal',
  family: 'Fira Code',
  weight: '400',
  lineHeight: '1.5',
  letterSpace: 'normal',
  sample: '1.2 km · 8 min ago',
};

function TableRow({ data }: Readonly<{ data: TypoScale }>) {
  return (
    <tr className="border-t border-carbon-stroke">
      <td className="font-mono text-xs font-semibold uppercase tracking-wide text-base-content/60">
        {data.label}
      </td>
