...
export default function LayoutSpacing() {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
      ...
      >
        Fireaway uses a simple responsive layout with consistent spacing to keep information easy to
        scan during emergency situations. The interface follows Tailwind's default spacing scale and
        a small set of responsive breakpoints.
      </p>
        ...
        {spacing.map((item, index) => (
          <div
            ...
            style={{
              ...
              padding: '16px 20px',
              background:
                index % 2 === 0 ? 'var(--color-carbon-card)' : 'var(--color-carbon-input)',
              borderBottom:
                index !== spacing.length - 1 ? '1px solid var(--color-carbon-stroke)' : 'none',
            }}
          >
          ...
          <div
            ...
            style={{
              ...
              background:
                index % 2 === 0 ? 'var(--color-carbon-card)' : 'var(--color-carbon-input)',
              borderBottom:
                index !== breakpoints.length - 1 ? '1px solid var(--color-carbon-stroke)' : 'none',
            }}
          >
