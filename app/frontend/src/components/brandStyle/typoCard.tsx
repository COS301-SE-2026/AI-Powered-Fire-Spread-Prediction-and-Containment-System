...
export function TypoCard({ data }: Readonly<{ data: TypoFamily }>) {
  return <div className="border border-carbon-stroke bg-base-200 p-8 text-center">
            ...
            <p className="mt-1 font-mono text-xs uppercase tracking-wide text-base-content/60">{data.source} | {data.license}</p>
        </div>
}