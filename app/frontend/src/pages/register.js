    ...
    <div className="min-h-screen bg-[#080B12] flex items-center justify-center p-4">
      <div className="w-full max-w-3xl bg-[#12151E] border border-white/10 rounded-xl p-6">
        ...
        >
          ...
          <div>
            <label htmlFor="surname" className="block text-sm text-white/60">
              Surname
            </label>
            <input
              id="surname"
          ...
          <div>
            <label htmlFor="idNumber" className="block text-sm text-white/60">
              ID/Passport Number
            </label>
            <input
              id="idNumber"
          ...
          <div className="md:col-span-2">
            <label htmlFor="role" className="block text-sm text-white/60">
              Role
            </label>
            <select
              id="role"
